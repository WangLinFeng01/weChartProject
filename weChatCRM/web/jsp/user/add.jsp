...
<html lang="zh-CN">
  <head>
	...
	<link re·l="stylesheet" href="${pageContext.request.contextPath}/css/doc.min.css">
	<style>
	.tree li {
  ...
  <body>
				  ...
				  <button type="button" class="btn btn-default btn-success dropdown-toggle" data-toggle="dropdown">
					<i class="glyphicon glyphicon-user"></i>小花 <span class="caret"></span>
					  ...
					  <ul class="dropdown-menu" role="menu">
						...
						<li class="divider"></li>
						<li><a href="${pageContext.request.contextPath}/login.jsp"><i class="glyphicon glyphicon-off"></i> 退出系统</a></li>
					  </ul>
			    </div>
			</li>
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form role="form" action="${pageContext.request.contextPath}/user/add" method="post">
				  ...
				  <input type="submit" id="insertBtn" name="insertBtn" class="btn btn-success" <i class="glyphicon glyphicon-plus">新增</i>>
	...
	<!--<script type="text/javascript">
	      function addUser() {
				var account = document.getElementById("loginacct").value;
				var userName=document.getElementById("username").value;
				var email=document.getElementById("email").value;
				console.log("1234");
				window.location.href="/jspexam/addServlet?account="+loginacct+"&userName="+username+"&email="+email;
		}
	</script>-->
  </body>
</html>